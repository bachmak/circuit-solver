...
#include "../scheme_configuration/elements.h"
...
{
public:
	void update(const IncMatrix& matrix, const Loops& loops, const Branches& branches, const Elements& elements);
...
private:
	...
	void update2ndLawEquations(const Loops& loops, const Branches& branches, const Elements& elements);

	size_t getCurrentSourceElemIndex(const size_t currentSourceIndex, const Elements& elements) const;
	size_t getVoltageSourceIndex(const size_t elemIndex, const Elements& elements) const;
};
